...
RawData *pAlgoMainRawData = NULL;
elevator_simulation_algo::AlgoElevator* pAlgoMain = NULL;
...
JNIEXPORT void JNICALL testAlgoStart(JNIEnv *env, jobject obj, jboolean isSim)
{
    ...
    RawData::StartSensors(isSim, "/sdcard/RawDataRec/tmp/");
    pAlgoMainRawData->attachJVM();
    pAlgoMain = new elevator_simulation_algo::AlgoElevator(pAlgoMainRawData, 50);
    elevator_simulation_algo::test_params_t cParams;
    pAlgoMain->init(cParams);
    pAlgoMain->start();
    mAlgoStarted = true;
}
...
********** Elevator *************************
***********************************************************/
#elif defined(APP_ELEVATOR)
#include "AlgoElevator.h"

RawData *pAlgoMainRawData = NULL;
elevator_simulation_algo::AlgoElevator* pAlgoMain = NULL;
std::string app_name = "APP_ELEVATOR";
...
/***********************************************************
********** TENSORFLOW PERSON DETECTOR **********************
***********************************************************/
#elif defined(APP_TENSORFLOW_PERSON_DETECTOR)

#include "AlgoTensorflowPersonDetector.h"
RawData *pAlgoMainRawData = NULL;
ninebot_tensorflow::AlgoTensorflowPersonDetector* pAlgoMain = NULL;
std::string app_name = "APP_TENSORFLOW_SAMPLE";
...
JNIEXPORT void JNICALL testAlgoStart(JNIEnv *env, jobject obj, jboolean isSim)
{
    ...
    RawData::StartSensors(isSim, "/sdcard/RawDataRec/tmp/");
    pAlgoMainRawData->attachJVM();
    pAlgoMain = new ninebot_tensorflow::AlgoTensorflowPersonDetector(pAlgoMainRawData, 33, true);
    pAlgoMain->start();
    mAlgoStarted = true;
}
...
#elif defined(APP_ELEVATOR)
    if(pAlgoMain){
        pAlgoMain->saveElevatorLocation();
    }
#endif
}
